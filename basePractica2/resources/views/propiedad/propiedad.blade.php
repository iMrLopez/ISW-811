...
<ul class="list-group">
  ...
  <li class="list-group-item">
    <div class="d-flex w-100 justify-content-between">
        <h5 class="mb-1">{{$prop->ubicacion}}</h5>
        <p class="mb-1">
        ...
        <ul class="list-group">
          <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span class="badge badge-primary badge-pill">{{$prop->cantidadHabitaciones}}</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
              <img src="{{ URL::to('img/car-in-a-garage.png') }}" alt="carros" style="width:30px;height:30px" />
            <span class="badge badge-primary badge-pill">{{$prop->cantidadCarros}}</span>
          </li>
        </ul>
    </div>
